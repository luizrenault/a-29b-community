...
--Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
	...
	Categories	= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},	
		...
		M_max									=	5400,  -- kg
		M_fuel_max								=   800, -- utilizável (real ~1000 L = ~800 kg JET-A) -- 800 = 400 esq + 400 dir (split simétrico)
        M_fuel_per_tank 						= 	{400, 400}, -- kg (real: ~1000 L total = ~800 kg, split simétrico esquerdo/direito)
		H_max									=	10668 , -- m
		...
		thrust_sum_max 				= 19040, -- thrust in kg (+12%)
		thrust_sum_ab 				= 19040, -- thrust in kg (+12%)
		...
		Pylons =     {
			pylon(1, 0, -0.200, -0.90, -3.273,
				...
				},
				{
	                ...
	                { CLSID = "{A29B_LAU_61_AGR_20_APKWS}" }, -- LAU-61 APKWS *19
	                { CLSID = "{A29B_LAU68_M282__APKWS_MPP}" }, -- LAU-68 APKWS *7
	                { CLSID = "{M299_2xAGM_114K}" }, -- M299 - 2x AGM-114K Hellfire *2
	                { CLSID = "{LAU_117_AGM_65E}" }, -- LAU-117 - AGM-65E Maverick Laser
	                { CLSID = "{F16A4DE0-116C-4A71-97F0-2CF85B0313EC}" }, -- AGM-65E Maverick GUID
	                { CLSID = "{LAU_117_AGM_65L}" }, -- LAU-117 - AGM-65L Maverick Laser
	...
	SFM_Data = {
		aerodynamics = 
		{
			...
			kjx = 2.25, -- Roll rate dampening 
			kjz = 0.00125,  -- Pitch rate dampening
		...
		engine = 
		{
			...
			extended = {
				...
				{ -- Minimum thrust 2240 kN, maximum thrust 18704 kN
					...
					thrust	 = {--KCAS 0       100      120      140      160     200     220     280      320     400
								{    19040,   19040,   19040,   19040,   19040,  19040,  19040,  19040,   18956,  19040 },--H = 0 (sea level)
								{    17920,   17920,   17920,   17920,   17920,  17920,  17920,  17920,   17920,  17920 },--H = 3048 (10kft)
								{    12880,   12880,   12880,   12880,   12880,  12880,  12880,  12880,   12880,  12880 },--H = 6096 (20kft)
								{     7840,    7840,    7840,    7840,    7840,   7840,   7840,   7840,    7840,   7840 },--H = 9144 (30kft)
								{     5600,    5600,    5600,    5600,    5600,   5600,   5600,   5600,    5600,   5600 },--H = 10500 (34kft)
								{     5600,    5600,    5600,    5600,    5600,   5600,   5600,   5600,    5600,   5600 },--H = 12192 (40kft)
				...
				{			-- factor = kg/h /2000
					...
					TSFC	 = {-- KT 0      	140     	160			200     	220 		260		300--0.1264
								{   150/1607,  195/1607,  205/1607,    243/1607,  271/1607, 347/1607, 380/1607},--H = 0       -- SL
								{   140/1607,  180/1607,  188/1607,    218/1607,  240/1607, 300/1607, 360/1607},--H = 1524    -- 5000' 
								{   130/1607,  152/1607,  175/1607,    195/1607,  215/1607, 268/1607, 330/1607},--H = 3048    -- 10000'
								{   120/1607,  120/1607,  160/1607,    177/1607,  191/1607, 234/1607, 285/1607},--H = 4572    -- 15000'
								{   115/1607,  115/1607,  135/1607,    165/1607,  175/1607, 210/1607, 250/1607},--H = 6096    -- 20000'
								{   110/1607,  110/1607,  110/1607,    160/1607,  165/1607, 195/1607, 210/1607},--H = 7620    -- 25000'
								{   110/1607,  110/1607,  110/1607,    152/1607,  165/1607, 175/1607, 175/1607},--H = 9144    -- 30000'
					}
				},
