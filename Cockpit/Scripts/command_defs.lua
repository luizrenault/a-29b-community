...
Keys =
{
    ...
    MassSelectorStep         = __custom_counter(),
    LateArmSelectorStep      = __custom_counter(),
    CMFDLeftFLIR             = __custom_counter(),
    CMFDRightFLIR            = __custom_counter(),
    CMFDLeftSMS              = __custom_counter(),
    CMFDRightSMS             = __custom_counter(),
