...
WPN_WEAPONS_NAMES["{A29B_LAU_61_AGR_20_APKWS}"]             = "APKWS19"
WPN_WEAPONS_NAMES["{A29B_LAU68_M282__APKWS_MPP}"]          = "APKWS7"
WPN_WEAPONS_NAMES["{A29B_HELLFIRE_DUAL_RAIL}"]             = "HELLFIRE2"
WPN_WEAPONS_NAMES["{A29B_MAVERICK_SINGLE_RAIL}"]           = "MAV1"
WPN_WEAPONS_NAMES["{A29B_MAVERICK_IR_SINGLE_RAIL}"]        = "MAVIR1"
WPN_WEAPONS_NAMES["{F16A4DE0-116C-4A71-97F0-2CF85B0313EC}"] = "AGM-65E"
WPN_WEAPONS_NAMES["{444BA8AE-82A7-4345-842E-76154EFCCA46}"] = "MAVIR1"
-- Native DCS launchers (post-2.9.26 migration)
WPN_WEAPONS_NAMES["{M299_2xAGM_114K}"]                      = "HELLFIRE2"
WPN_WEAPONS_NAMES["{LAU_117_AGM_65E}"]                      = "AGM-65E"
WPN_WEAPONS_NAMES["{LAU_117_AGM_65L}"]                      = "AGM-65L"
WPN_WEAPONS_NAMES["{B06DD79A-F21E-4EB9-BD9D-AB3844618C93}"] = "AGM-65L"
-- "AGM114x2_OH_58" already mapped below to "AGM114" (OH-58 dual-rail variant)
