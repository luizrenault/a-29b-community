...
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_GUNS_L"}
...
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_GUNS_R"}
object.controllers = {{"opacity_using_parameter", 0}, {"text_using_parameter", 1, 0}}

object = addStrokeText("SMS_POS_5_TEXT", "TANK", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0.53, -0.518}, nil, nil,{"%s"}, CMFD_FONT_W)
...
object = addStrokeText("SMS_POS_4_TEXT", "TANK", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0.277, -0.229}, nil, nil,{"%s"}, CMFD_FONT_W)
...
object = addStrokeText("SMS_POS_3_TEXT", "TANK", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {0, 0.1}, nil, nil,{"%s"}, CMFD_FONT_W)
...
object = addStrokeText("SMS_POS_2_TEXT", "TANK", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {-0.277, -0.229}, nil, nil,{"%s"}, CMFD_FONT_W)
...
object = addStrokeText("SMS_POS_1_TEXT", "TANK", CMFD_STRINGDEFS_DEF_X08, "CenterCenter", {-0.53, -0.518}, nil, nil,{"%s"}, CMFD_FONT_W)
...
object = addStrokeText(nil, "INV", CMFD_STRINGDEFS_DEF_X2, "CenterCenter", {0, -0.65}, SMS_submode_inv.name, nil, nil, CMFD_FONT_W)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_INV"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, 1}}
...
object = addStrokeText(nil, "SIM-NO SJ", CMFD_STRINGDEFS_DEF_X2, "CenterCenter", {0, -0.65}, SMS_mode_sj.name, nil, nil, CMFD_FONT_W)
...
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SIGHT"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SIGHT_IDS.SNAP}}
object = addOSSText(2, "LCOS", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SIGHT"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SIGHT_IDS.LCOS}}
object = addOSSText(2, "SSLC", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SIGHT"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SIGHT_IDS.SSLC}}

object = addOSSText(7, "QTY TYPE", SMS_mode_aa_oss.name, nil, nil, {"%01.0f ", "%S"})
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_QTY", "SMS_AA_NAME"}
...
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_INTRG_QTY"}
object.controllers = {{"opacity_using_parameter", 0}, {"text_using_parameter", 1, 0}}

object = addOSSText(9, "RR\nRATE", SMS_mode_aa_oss.name, nil, nil, {"RR\n%01.0f"})
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_RR"}
object.controllers = {{"opacity_using_parameter", 0}, {"text_using_parameter", 1, 0}}

object = addOSSText(10, "DL", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_RR_SRC"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_RR_SRC_IDS.DL}}
object = addOSSText(10, "MAN", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_RR_SRC"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_RR_SRC_IDS.MAN}}

object = addOSSText(11, "DL", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SLV_SRC"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SLV_SRC_IDS.DL}}
object = addOSSText(11, "BST", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SLV_SRC"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SLV_SRC_IDS.BST}}

object = addOSSText(25, "COOL", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_COOL"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_COOL_IDS.COOL}}
object = addOSSText(25, "WARM", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_COOL"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_COOL_IDS.WARM}}

object = addOSSText(26, "SPOT", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SCAN"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SCAN_IDS.SPOT}}
object = addOSSText(26, "SCAN", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_SCAN"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_SCAN_IDS.SCAN}}

object = addOSSText(27, "TD", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_LIMIT"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_LIMIT_IDS.TD}}
object = addOSSText(27, "BP", SMS_mode_aa_oss.name)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "SMS_AA_LIMIT"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, SMS_AA_LIMIT_IDS.BP}}
