...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.EGI}}
object = addStrokeText("ADHSI_MODE_VOR", "VOR", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.87, 0.63})
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "ANS_MODE"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.VOR}}
object = addStrokeText("ADHSI_MODE_GPS", "GPS", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.87, 0.63}, nil, nil,nil, CMFD_FONT_B)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "ANS_MODE"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.GPS}}
object = addStrokeText("ADHSI_MODE_ILS", "ILS", CMFD_STRINGDEFS_DEF_X1, "CenterCenter", {-0.87, 0.63}, nil, nil,nil, CMFD_FONT_W)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT", "ANS_MODE"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.ILS}}
...
HSI_VOR_Origin.controllers = {{"rotate_using_parameter", 0, -math.rad(1)}, {"parameter_in_range",0,-0.05, 360.05}, {"parameter_in_range", 1, ANS_MODE_IDS.EGI - 0.05, ANS_MODE_IDS.GPS + 0.05}}
...
HSI_VOR_RED_Origin.controllers = {{"parameter_compare_with_number",0, -1}, {"parameter_in_range", 1, ANS_MODE_IDS.EGI - 0.05, ANS_MODE_IDS.GPS + 0.05}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_in_range", 1, -0.05, 360.05}, {"text_using_parameter", 1, 0}, {"text_using_parameter", 1, 1}, {"text_using_parameter", 2, 2}, {"text_using_parameter", 3, 3}, {"text_using_parameter", 4, 4}, {"parameter_in_range", 5, ANS_MODE_IDS.EGI - 0.05, ANS_MODE_IDS.VOR + 0.05}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, -1},  {"parameter_in_range", 2, ANS_MODE_IDS.EGI - 0.05, ANS_MODE_IDS.VOR + 0.05}}
...
HSI_GPS_Origin.controllers = {{"rotate_using_parameter", 0, -math.rad(1)}, {"parameter_in_range",0 , -0.05, 360.05}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.GPS}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_in_range", 1, -0.05, 360.05}, {"text_using_parameter", 1, 0}, {"text_using_parameter", 1, 1}, {"text_using_parameter", 2, 2}, {"text_using_parameter", 3, 3}, {"text_using_parameter", 4, 4}, {"parameter_compare_with_number", 5, ANS_MODE_IDS.GPS}}
object = addStrokeText("HSI_GPS_NOATA_text", "GPS\nXXX`\nX.XX\nXX:XX", CMFD_STRINGDEFS_DEF_X08, "LeftCenter", {-0.6, -0.086}, nil, nil, nil, CMFD_FONT_B)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT",  "ADHSI_GPS_HDG", "ADHSI_GPS_DIST", "ADHSI_GPS_MIN", "ADHSI_GPS_SEC", "ANS_MODE"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, -1}, {"text_using_parameter", 1, 0}, {"text_using_parameter", 1, 1}, {"text_using_parameter", 2, 2}, {"text_using_parameter", 3, 3}, {"text_using_parameter", 4, 4}, {"parameter_compare_with_number", 5, ANS_MODE_IDS.GPS}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, 1}, {"move_left_right_using_parameter", 2, 1},
                        {"change_color_when_parameter_equal_to_number", 3, ANS_MODE_IDS.EGI, 1,0,1},
                        {"change_color_when_parameter_equal_to_number", 3, ANS_MODE_IDS.VOR, 0,1,0},
                        {"change_color_when_parameter_equal_to_number", 3, ANS_MODE_IDS.GPS, 0,0,1},
                     }
...
HSI_FYT_DTK_Origin.controllers = {{"rotate_using_parameter", 0, -math.rad(1)}, {"parameter_in_range", 0, -0.05, 360,05}, {"parameter_in_range", 1, ANS_MODE_IDS.EGI-0.05, ANS_MODE_IDS.GPS + 0.05}}
...
-- object.controllers = {{"opacity_using_parameter", 0}, {"text_using_parameter", 1, 0}, {"parameter_in_range",1 , -0.05, 360.05}, {"change_color_when_parameter_equal_to_number", 2, ANS_MODE_IDS.GPS, 0, 0, 0, 0}, {"parameter_in_range", 2, ANS_MODE_IDS.VOR-0.05, ANS_MODE_IDS.ILS+0.05}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.EGI}, {"text_using_parameter", 2,0}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.VOR}, {"text_using_parameter", 2,0}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.GPS}, {"text_using_parameter", 2,0}}
...
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, ANS_MODE_IDS.ILS}, {"text_using_parameter", 2,0}}

-- DME DATA Indicator
object = addStrokeText("HSI_DME_DATA_text", "", CMFD_STRINGDEFS_DEF_X08, "LeftCenter", {-0.6, -0.086}, nil, nil, {"DME\n%2.1f\n", "%02.0f:", "%02.0f\n"}, CMFD_FONT_W)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT",  "ADHSI_VOR_HDG", "ADHSI_VOR_DIST", "ADHSI_VOR_MIN", "ADHSI_VOR_SEC", "ANS_MODE"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_in_range", 1, -0.05, 360.05}, {"parameter_compare_with_number", 5, ANS_MODE_IDS.ILS}, {"text_using_parameter", 2, 0}, {"text_using_parameter", 3, 1}, {"text_using_parameter", 4, 2}}
object = addStrokeText("HSI_DME_NODATA_text", "DME\nX.X\nXX:XX\n", CMFD_STRINGDEFS_DEF_X08, "LeftCenter", {-0.6, -0.086}, nil, nil, nil, CMFD_FONT_W)
object.element_params = {"CMFD"..tostring(CMFDNu).."_BRIGHT",  "ADHSI_VOR_HDG", "ANS_MODE"}
object.controllers = {{"opacity_using_parameter", 0}, {"parameter_compare_with_number", 1, -1},  {"parameter_compare_with_number", 2, ANS_MODE_IDS.ILS}}
